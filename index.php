...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-176426004-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-176426004-1');
</script>
<!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-THJR7NT');</script>
...
<div class=" container-fluid border px-0 light-gray-color">
  <!--    navbar section-->
  <div class="navbar-section md-px-5 w-100">
    <nav class="navbar-box">
      <div class="navbar d-flex">
        ...
        <div>
          ...
          <ul class="nav-ul">
            <li><i class="fas fa-bars"></i></li>
            <li><a class="nav-links " href="#portfolio">Portfolio</a></li>
  ...
  <div id="home" class="background-section">
    <div class="background">
      <div class="backgroung-image md-px-5">
        <div>
      ...
      <div class="introduction d-flex justify-content-center">
        <div class="w-100">
          ...
          <p>
            ...
            <a class="introduction-links pl-2" href="https://api.whatsapp.com/send?phone=923326037639&text=Just watched your resume! Need to contact you.." target="_blank"><i class="fab fa-whatsapp"></i></a>
          </p>
        </div>
      </div>
    </div>
